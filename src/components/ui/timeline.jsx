  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl mb-4 text-white dark:text-white max-w-8xl">
          Experience
        </h2>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-linear-to-b from-purple-500 via-blue-500 to-transparent from-[0%] via-90% rounded-full"
          />
        </div>
      </div>
    </div>

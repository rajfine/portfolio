...
function DockItem({ children, className, onClick, href }) {
        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className={cn(
                        'absolute -top-6 left-1/2 w-fit whitespace-pre rounded-md border border-white bg-white  px-2 py-0.5 text-sm text-neutral-700 dark:border-neutral-900 dark:bg-neutral-800 dark:text-white',
                        className
                    )}
                    role='tooltip'
                    style={{ x: '-50%' }}
